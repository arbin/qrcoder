...
DATABASES = {
    'default': {
        ...
        'NAME': 'dbqrcoder',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '!8zuo8lp-!3l)#rth2hs+o8t3d509d7s+&amp;yes+z3#ul0%91w89'
...
WSGI_APPLICATION = 'qrcoder.wsgi.application'
